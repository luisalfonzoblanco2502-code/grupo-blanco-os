// Configuración del Express app, separada de index.js para poder
// reutilizarla tanto en local (`node --watch src/index.js`, que sí llama
// app.listen) como en Vercel (`api/index.js`, que solo necesita el handler
// sin listen — Vercel lo envuelve en su propio runtime serverless).
